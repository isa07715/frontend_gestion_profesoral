...
class UsuarioService:
    def __init__(self):
        ...
        self.api_url = f"{self.base_url}/usuario"
    ...
    def create(self, data):  # ✅ El argumento se llama 'data'
        try:
            # ✅ Usamos 'data' aquí para enviar al JSON
    ...
    def update(self, id, data):  # ✅ El argumento se llama 'data'
        try:
